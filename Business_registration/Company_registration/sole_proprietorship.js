/* Sole Proprietorship Registration page functionality */
...
(function () {
    ...
    if (reduced) {
        items.forEach(item => item.classList.add("prop-visible"));
    } else {
        const observer = new IntersectionObserver((entries, obs) => {
            entries.forEach(entry => {
                if (!entry.isIntersecting) return;
                entry.target.classList.add("prop-visible");
    ...
    ========================================================= */
    const form = document.getElementById("propLeadForm");
    const success = document.getElementById("propFormSuccess");
...
========================================================= */
(function () {
    const sideNav = document.getElementById("siSideNav") || document.getElementById("propSideNav");
    if (!sideNav) return;
